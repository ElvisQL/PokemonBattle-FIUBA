...
public class Constants {
    ...
    public static final Double RANDOM_ATTACK_FACTOR = (Math.random() * 39 + 217) / 255.0;
    public static final Double CRITICAL_ATTACK = 2.0;
    public static final Double NOT_CRITICAL_ATTACK = 1.0;
    public static final Double HEALTH_LOSS_PERCENTAGE = 0.05;
